...
(2) You do not have to accept input from the console. You have to write the function definition and within the function, create a file named out.txt according to the required specification.
''' 
